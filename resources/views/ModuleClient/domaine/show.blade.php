<div id="show-parent">
    <div class="modal fade" id="show-domaines">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Détails d'un domaine de formation</h4>
                    ...
                    @isset($domaine)
                        <form class="forms-sample form-horizontal">
                            ...
                            <div class="mb-3 row">
                                ...
                                <label class="form-label  col-lg-8 col-6">
                                    {!! isset($domaine->created_at) ? $domaine->created_at->format('d/m/Y à H:i:s') : '' !!}
                                </label>
                            </div>
                        </form>
                    @endisset
