<div class="table-responsive  table-responsive-sm">
    <table class="table table-hover table-bordered table-striped table-responsive-sm" id="domaines-table">
        <thead>
        <tr>
            <th>#</th>
            <th>Libéllé</th>
            ...
            <tr>
                ...
                <td width='85'>
                    <button type="button" class="btn btn-info btn-xxs" title="Détails"
                            onclick="lunchShowModal({!! $domaine->id !!})">
                        <i class="mdi mdi-eye"></i>
                    </button>
                    
                        <button type="button" class="btn btn-warning btn-xxs" title="Modifier"
                                onclick="lunchEditModal({!! $domaine->id !!})">
                            <i class="mdi mdi-pencil"></i>
                        </button>
                  
                        <button type="button" class="btn btn-danger btn-xxs" title="Supprimer"
                                onclick="lunchDeletionModal({{ $domaine->id }},'{!! addslashes($domaine->description) !!}')">
