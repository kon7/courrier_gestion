<div id="edit-parent">
    <div class="modal fade" id="edit-domaines">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Modification d'un domaine de formation</h4>
                ...
                @isset($domaine)
                    {!! Form::model($domaine, ['id' => 'edit-form','route' => ['client.domaines.update', $domaine->id], 'method' => 'patch','class' => 'form-horizontal']) !!}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        {!! Form::text('id', null, ['id' => 'edit-id_domaine','hidden']) !!}
                        {!! Form::text('editd_by', null, ['id' => 'edit-editd_by','hidden']) !!}
                        <div class="row">
                            <div class="mb-3">
                                {!! Form::label('name', 'Libellé du domaine : *',['for' => 'edit-name','class' => 'col-sm-6 form-label form-label-sm', 'style'=>'font-weight:800;color:#1f1f1f;']) !!}
                                {!! Form::text('name', null, ['class' => 'form-control form-control-sm', 'required', 'maxlength' => 254]) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
                                {!! Form::label('description', 'Description du domaine : ',['for' => 'edit-description','class' => 'col-sm-6 form-label form-label-sm', 'style'=>'font-weight:800;color:#1f1f1f;']) !!}
