<div id="create-parent">
    <div class="modal fade" id="create-domaines">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Enregistrement d'un domaine de formation</h4>
                ...
                {!! Form::open(['id' => 'create-form','route' => 'client.domaines.store','class' => 'forms-sample form-horizontal']) !!}
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-3">
                            {!! Form::label('name', 'Libellé du domaine : *',['for' => 'create-name_domaine','class' => 'col-sm-6 form-label form-label-sm', 'style'=>'font-weight:800;color:#1f1f1f;']) !!}
                            {!! Form::text('name', null, ['class' => 'form-control form-control-sm', 'required', 'maxlength' => 254]) !!}
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3">
                            {!! Form::label('description', 'Description du domaine : ',['for' => 'create-desc_domaine','class' => 'col-sm-6 form-label form-label-sm', 'style'=>'font-weight:800;color:#1f1f1f;']) !!}
